...
data class AppCapabilitySnapshot(
    ...
    val accessibilityStatusLabel: String
        get() = when (accessibilityState) {
            ServiceBindingState.READY -> "Activado"
            ServiceBindingState.CONNECTING -> "Conectando"
            ServiceBindingState.DEGRADED -> "Desconectado"
            ServiceBindingState.DISABLED -> "Desactivado"
        }

    val notificationAccessStatusLabel: String
        get() = when (notificationAccessState) {
            ServiceBindingState.READY -> "Conectado"
            ServiceBindingState.CONNECTING -> "Conectando"
            ServiceBindingState.DEGRADED -> "Desconectado"
            ServiceBindingState.DISABLED -> "Desactivado"
        }
    ...
    val notificationPermissionStatusLabel: String
        get() = if (notificationPermissionGranted) "Activado" else "Desactivado"
}
