package com.blackclaw.android.floating
...
object FloatingCircleManager {
    ...
    private var currentTokenState: com.blackclaw.android.agent.TokenMonitor.State = com.blackclaw.android.agent.TokenMonitor.State.NORMAL
     ...
     */
    fun updateTokenStatus(step: Int, formattedTokens: String, formattedCost: String, tokenState: com.blackclaw.android.agent.TokenMonitor.State) {
        ThreadUtils.runOnUiThread {
            currentRound = step
            ...
            val colorRes = when (tokenState) {
                com.blackclaw.android.agent.TokenMonitor.State.NORMAL -> R.color.colorBrandPrimary
                com.blackclaw.android.agent.TokenMonitor.State.CAUTION -> R.color.colorWarningPrimary
                com.blackclaw.android.agent.TokenMonitor.State.WARNING -> R.color.colorWarningPrimary
                com.blackclaw.android.agent.TokenMonitor.State.CRITICAL -> R.color.colorErrorPrimary
            }
            try {
