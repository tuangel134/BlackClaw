 ...
 *
 * Storage: /storage/emulated/0/BlackClaw/chats/
...
object ChatHistoryManager {
    ...
    private const val MESSAGE_TIMESTAMP_PREFIX = "<!-- blackclaw:timestamp="
    ...
    fun rename(file: File, newTitle: String): Boolean {
        ...
        try {
            ...
            com.blackclaw.android.utils.XLog.e("ChatHistoryManager", "Failed to rename conversation", e)
            return false
        }
    }
