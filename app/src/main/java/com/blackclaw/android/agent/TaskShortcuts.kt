    ...
    private fun takeScreenshot(context: Context): String {
        return try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                ...
                val svc = com.blackclaw.android.service.ClawAccessibilityService.getInstance()
                if (svc != null) {
                    ...
                    "Screenshot requires Accessibility permission. Please enable BlackClaw in Accessibility settings."
                }
            } else {
    ...
    private fun pressBack(context: Context): String {
        return try {
            ...
            if (svc != null) {
                ...
                "Back shortcut requires Accessibility permission. Please enable BlackClaw in Accessibility settings."
            }
        } catch (e: Exception) {
